...
### Added
- **Streaming application guide**: Documented suite-scoped Rails and auxiliary services, Playwright orchestration, Rails-side data setup, streaming assertions, and the HiChee migration pattern. [PR 264](https://github.com/shakacode/cypress-playwright-on-rails/pull/264) by [justin808](https://github.com/justin808).
